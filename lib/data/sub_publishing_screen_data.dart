...
class SubPublishingScreenData {
  ...
  static List<SubPublishingModel> subPublishingData(
    ...
    List<SubPublishingModel> pItem = [
      ...
      SubPublishingModel(
        pDescription:
            'The Nino & Mia Coloring Book is a must-have book for all children who are in love with the "Nino & Mia" cartoon series available on the BET KANU youtube channel. Children will go through all of the thirteen Surit episodes of season ane of the series by coloring their way to the end of the book while learning good habits and lessons with Nino and his fictional friend Mia.',
        pFeatures: 'Features:\n' +
            'Many episodes of the Nino & Mia cartoon series\n' +
            'The ability to watch the video by scanning the code\n' +
            'Possibility to color the graphics.\n' +
            'QR Codes for video, audio, texts and images.\n' +
            'Uses the BET KANU READER APP',
        pCredits: 'Credits:\n' +
            'LAYOUT DESIGN: ORNINA SHABO, MERAY YOUSSEF\n' +
            'GRAPHIC DESIGNER: ORNINA SHABO\n' +
            'PROJECT MANAGER: DILAMA MALKI\n' +
            'SUPER VISION: RAMINA SAMUEL, AKKAD SAADI, SAMIR SHAMOUN\n' +
            'VISUALS: SARGON SAADI\n' +
            'AUDIO EDITING: GEORGE AFRAM\n' +
            'SYRIAC ORTHOGRAPHY EDITOR: D. ABDUL MASSIH SAADI\n' +
            'AUTHOR: BET KANU TEAM\n' +
            'ILLUSTRATION AND ANIMATION: GABI MALKI, MILAD YOUSSEF, GABI SHABO, AMMAR YOUSSEF',
        pSubImages: SubPublishingImagesListViewWidget(
